  ...
  <view class="sk-container">
      ...
      <view class="goods goods">
        <view class="preview preview">
          ...
          <view class="indicator indicator">
            <text class="current sk-transparent sk-opacity">3</text>
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-751 sk-text">168.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-345 sk-text"
            >梅乃宿梅酒720毫升</view
          >
          <view class="desc sk-transparent sk-text-0-0000-778 sk-text"
            >小藏手工酿造，百年名酒app</view
          >
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-961 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-468 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-998 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-130 sk-text">
              请选择收获地址
            </text>
          </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 0px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-377 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-733 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
...
<style>
/*
此文件为开发者工具生成，生成时间: 2024/4/10下午4:56:40

在 /Users/meizu/Downloads/PIC/canvas/threejs/uniapp/heima-shop/dist/dev/mp-weixin/pages/goods/goods.wxss 中引入样式
```
